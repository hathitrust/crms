...
my $dWorld2 = $crms->SimpleSqlGet('SELECT COUNT(*) FROM exportdata WHERE time>?', $start);
my $pdWorld = $crms->SimpleSqlGet('SELECT COUNT(*) FROM exportdata WHERE attr="pd" OR attr="pdus"');
my $pdWorld2 = $crms->SimpleSqlGet('SELECT COUNT(*) FROM exportdata WHERE (attr="pd" OR attr="pdus") AND time>?', $start);
...
my $pdicusWorld2 = $crms->SimpleSqlGet('SELECT COUNT(*) FROM exportdata WHERE (attr="pd" OR attr="icus") AND time>?', $start);
...
my $timeWorld2 = $crms->SimpleSqlGet($sql. ' AND time>?', $start) || 0;

my $dUS = $crmsUS->SimpleSqlGet('SELECT COUNT(*) FROM exportdata');
my $dUS2 = $crmsUS->SimpleSqlGet('SELECT COUNT(*) FROM exportdata WHERE time>?', $start);
my $pdUS = $crmsUS->SimpleSqlGet('SELECT COUNT(*) FROM exportdata WHERE attr="pd" OR attr="pdus"');
my $pdUS2 = $crmsUS->SimpleSqlGet('SELECT COUNT(*) FROM exportdata WHERE (attr="pd" OR attr="pdus") AND time>?', $start);
...
my $timeUS2 = $crmsUS->SimpleSqlGet($sql. ' AND time>?', $start) || 0;
