...
subtest "#format" => sub {
  ...
  foreach my $test (@$test_data) {
    my $pd = CRMS::PublicationDate->new(
      ...
      date_1 => $test->[1],
      date_2 => $test->[2]);
    is($pd->format, $test->[3], "String for type $test->[0] ($test->[1], $test->[2])");
  }
};
...
my $TEST_DATA = [
    ...
    # ==== =====  =====   =============     ====================  ======================  ==============
    ['b', '####', '####', [],               undef,                undef,                  0],
    ['c', '19uu', '9999', ['1900', '9999'], undef,                '9999',                 0],
    ['d', '1uuu', '1958', ['1000', '1958'], undef,                '1958',                 0],
    ['d', '1945', '19uu', ['1945', '1999'], undef,                '1999',                 0],
    ['e', '1983', '0615', ['1983'],         '1983',               '1983',                 1],
    # FIXME: do we have examples of type e with underspecified date1?
    ['i', '1765', '1770', ['1765', '1770'], undef,                '1770',                 0],
    ['i', '18uu', '1890', ['1800', '1890'], undef,                '1890',                 0],
    ['i', '1988', '1988', ['1988'],         '1988',               '1988',                 1],
    ['k', '1796', '1896', ['1796', '1896'], undef,                '1896',                 0],
    ['k', '1854', '1854', ['1854'],         '1854',               '1854',                 1],
    ['m', '1972', '1975', ['1972', '1975'], undef,                '1975',                 0],
    ['m', 'uuuu', '1981', ['0000', '1981'], undef,                '1981',                 0],
    ['m', '197u', '1987', ['1970', '1987'], undef,                '1987',                 0],
    ['m', '1943', '197u', ['1943', '1979'], undef,                '1979',                 0],
    ['m', '1998', '9999', ['1998', '9999'], undef,                '9999',                 0],
    ['m', 'uuuu', 'uuuu', ['0000', '9999'], undef,                '9999',                 0],
    ['n', 'uuuu', 'uuuu', [],               undef,                undef,                  0],
    ['p', '1982', '1967', ['1967'],         '1967',               '1967',                 1],
    ['q', '1963', '1966', ['1963', '1966'], undef,                '1966',                 0],
    ['q', '18uu', '19uu', ['1800', '1999'], undef,                '1999',                 0],
    ['r', '1983', '1857', ['1857'],         '1857',               '1857',                 1],
    ['r', '1966', 'uuuu', [],               undef,                undef,                  0],
    ['r', 'uuuu', '1963', ['1963'],         '1963',               '1963',                 1],
    ['s', '1946', '####', ['1946'],         '1946',               '1946',                 1],
    ['s', '198u', '####', ['1980', '1989'], undef,                '1989',                 0],
    ['s', '19uu', '####', ['1900', '1999'], undef,                '1999',                 0],
    ['t', '1982', '1949', ['1949'],         '1949',               '1949',                 1],
    ['t', '198u', '1979', ['1979'],         '1979',               '1979',                 1],
    ['u', '1948', 'uuuu', ['1948', '9999'], undef,                '9999',                 0],
    ['u', '19uu', 'uuuu', ['1900', '9999'], undef,                '9999',                 0],
    ['u', '1uuu', 'uuuu', ['1000', '9999'], undef,                '9999',                 0],
    # Degenerate examples
    ['s', 'abcd', '####', [],               undef,                undef,                  0],
